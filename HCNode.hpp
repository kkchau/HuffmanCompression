 ...
 * Filename: HCNode.hpp
 * Description: Header file for HCNodes; contains HCNode ctor
...
public:
    ...
    /** inorder traversal of trie, prints out each HCNode
     */
    void inorder(HCNode* n) const;

    /** Write the freqency of this node/symbol in 3 bytes
     */
    void writeFreq(ofstream& out);
};
